 ...
 * 
 */
package com.cathay.springboot.starter.scheduler;
...
import com.cathay.scheduler.JobRegistry;
import com.cathay.scheduler.SchedulerFactoryBeanWrapper;
import com.cathay.scheduler.registry.NullJobRegistry;
import com.cathay.scheduler.registry.ZkJobRegistry;
...
@ConditionalOnProperty(name="cathay.task.groupName")

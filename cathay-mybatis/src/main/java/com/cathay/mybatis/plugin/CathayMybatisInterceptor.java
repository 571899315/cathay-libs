package com.cathay.mybatis.plugin;
...
@Intercepts({  
    ...
    @Signature(type = Executor.class, method = "query", args = {  
            ...
            ResultHandler.class }) })  
public class CathayMybatisInterceptor implements Interceptor,DisposableBean{

	protected static final Logger logger = LoggerFactory.getLogger("com.cathay.mybatis");
	...
	public CathayMybatisInterceptor(String groupName, String[] hanlderNames) {

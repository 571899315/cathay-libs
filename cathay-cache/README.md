...
<dependency>
	...
	<artifactId>cathay-cache</artifactId>
...
```
  <bean id="jedisPoolConfig" class="redis.clients.jedis.JedisPoolConfig">
    ...
    <!--第一组缓存-->
	<bean id="defaultCache" class="com.cathay.cache.redis.JedisProviderFactoryBean">
	...
	<bean id="sessionCache"
		class="com.cathay.cache.redis.JedisProviderFactoryBean">
...
```
    <bean id="level1CacheSupport" class="com.cathay.cache.local.Level1CacheSupport">
         ...
         <property name="cacheProvider">
            <!-- <bean class="com.cathay.cache.local.GuavaLevel1CacheProvider">
               <property name="maxSize" value="10000" />
               <property name="timeToLiveSeconds" value="300" />
            </bean> -->
            <bean class="com.cathay.cache.local.EhCacheLevel1CacheProvider">

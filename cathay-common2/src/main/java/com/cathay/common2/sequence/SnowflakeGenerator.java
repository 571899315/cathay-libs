 ...
 * 
 */
package com.cathay.common2.sequence;
...
public class SnowflakeGenerator implements IdGenerator, Watcher {
	...
	public SnowflakeGenerator() {
		try {
			String appName = ResourceUtils.getProperty("spring.application.name", ResourceUtils.getProperty("cathay.configcenter.appName"));

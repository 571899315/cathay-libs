package com.cathay.common2.lock.zk;
...
import com.cathay.common2.lock.LockException;
...
public class ZkDistributeLock implements Lock,Watcher {
	...
	static{
		zkServers = ResourceUtils.getProperty("cathay.lock.zkServers");
	}
	...
	public ZkDistributeLock(String lockName,int sessionTimeout) {
		...
		Validate.notBlank(zkServers, "config[cathay.lock.zkServers] not found");

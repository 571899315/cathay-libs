...
import com.cathay.kafka.thread.StandardThreadExecutor;
import com.cathay.kafka.thread.StandardThreadExecutor.StandardThreadFactory;

public abstract class AbstractTopicConsumer implements Closeable{
	
	private final static Logger logger = LoggerFactory.getLogger("com.cathay.kafka.consumer");

 ...
 * 
 */
package com.cathay.common.util;
...
public final class ResourceUtils {
	...
	private synchronized static void load() {
		if(inited)return;
		try {
        	Class<?> threadClazz = Class.forName("com.cathay.spring.helper.EnvironmentHelper");
		...
		try {
			...
			URL url = Thread.currentThread().getContextClassLoader().getResource("");
			 System.setProperty("framework.website", "www.cathay.com");

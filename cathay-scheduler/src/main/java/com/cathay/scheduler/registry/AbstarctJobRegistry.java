 ...
 */
package com.cathay.scheduler.registry;
...
import com.cathay.scheduler.model.JobConfig;
import com.cathay.scheduler.monitor.MonitorCommond;
...
public abstract class AbstarctJobRegistry implements JobRegistry{
	...
	private static final Logger logger = LoggerFactory.getLogger("com.cathay.scheduler.registry");

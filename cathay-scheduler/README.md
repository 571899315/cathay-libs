...
<dependency>
	...
	<artifactId>cathay-scheduler</artifactId>
	...
	<bean class="SchedulerFactoryBeanWrapper">
		...
		<property name="schedulers">
			<list>
				...
				<bean class="com.cathay.test.sch.DemoTask2">
					<property name="jobName" value="demoTask2" />
					<property name="cronExpr" value="0/15 * * * * ?" />
				</bean>
				
				<!-- <bean class="com.cathay.test.sch.DemoParallelTask">
